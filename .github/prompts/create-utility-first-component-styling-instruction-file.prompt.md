---
name: create-utility-first-component-styling-instruction-file
description: Create or refresh the instruction file for Utility-first component styling in this repository.
...
# Create Utility-first component styling Instruction File
...
- Set description to practical guidance for using Utility-first component styling in this codebase.
- Set applyTo to: src/**/*.tsx|src/app/globals.css.
...
Output:
- Return only the final markdown content for .github/instructions/utility-first-component-styling.instructions.md.
