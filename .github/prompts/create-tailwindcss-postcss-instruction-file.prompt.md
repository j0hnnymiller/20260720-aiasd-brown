---
name: create-tailwindcss-postcss-instruction-file
description: Create or refresh the instruction file for @tailwindcss/postcss in this repository.
...
# Create @tailwindcss/postcss Instruction File

Create or update .github/instructions/tailwindcss-postcss.instructions.md as a complete markdown instruction file with YAML front matter.

Requirements:
- Set name to the technology name.
- Set description to practical guidance for using @tailwindcss/postcss in this codebase.
- Set applyTo to: postcss.config.mjs|src/**/*.css.
...
Output:
- Return only the final markdown content for .github/instructions/tailwindcss-postcss.instructions.md.
