---
name: create-next-font-google-instruction-file
description: Create or refresh the instruction file for next/font/google in this repository.
...
# Create next/font/google Instruction File

Create or update .github/instructions/next-font-google.instructions.md as a complete markdown instruction file with YAML front matter.

Requirements:
- Set name to the technology name.
- Set description to practical guidance for using next/font/google in this codebase.
- Set applyTo to: src/app/layout.tsx|src/**/*.tsx.
...
Output:
- Return only the final markdown content for .github/instructions/next-font-google.instructions.md.
