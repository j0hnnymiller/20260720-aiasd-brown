---
name: create-typescript-instruction-file
description: Create or refresh the instruction file for TypeScript 5 in this repository.
...
# Create TypeScript 5 Instruction File
...
Output:
- Return only the final markdown content for .github/instructions/typescript.instructions.md.
