---
name: create-next-start-instruction-file
description: Create or refresh the instruction file for next start in this repository.
...
# Create next start Instruction File

Create or update .github/instructions/next-start.instructions.md as a complete markdown instruction file with YAML front matter.

Requirements:
- Set name to the technology name.
- Set description to practical guidance for using next start in this codebase.
- Set applyTo to: package.json|README.md.
...
Output:
- Return only the final markdown content for .github/instructions/next-start.instructions.md.
