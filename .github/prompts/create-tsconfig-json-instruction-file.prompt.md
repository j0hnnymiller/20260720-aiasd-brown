---
name: create-tsconfig-json-instruction-file
description: Create or refresh the instruction file for tsconfig.json in this repository.
...
# Create tsconfig.json Instruction File
...
- Set description to practical guidance for using tsconfig.json in this codebase.
- Set applyTo to: tsconfig.json.
...
Output:
- Return only the final markdown content for .github/instructions/tsconfig-json.instructions.md.
