---
name: create-eslint-9-instruction-file
description: Create or refresh the instruction file for ESLint 9 in this repository.
...
# Create ESLint 9 Instruction File

Create or update .github/instructions/eslint-9.instructions.md as a complete markdown instruction file with YAML front matter.

Requirements:
- Set name to the technology name.
- Set description to practical guidance for using ESLint 9 in this codebase.
- Set applyTo to: eslint.config.mjs|package.json.
...
Output:
- Return only the final markdown content for .github/instructions/eslint-9.instructions.md.
