---
name: create-nextjs-instruction-file
description: Create or refresh the instruction file for Next.js 16.2.10 in this repository.
...
# Create Next.js 16.2.10 Instruction File

Create or update .github/instructions/nextjs.instructions.md as a complete markdown instruction file with YAML front matter.

Requirements:
- Set name to the technology name.
- Set description to practical guidance for using Next.js 16.2.10 in this codebase.
- Set applyTo to: src/app/**|next.config.ts.
...
Output:
- Return only the final markdown content for .github/instructions/nextjs.instructions.md.
