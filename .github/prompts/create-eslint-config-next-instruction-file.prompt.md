---
name: create-eslint-config-next-instruction-file
description: Create or refresh the instruction file for eslint-config-next in this repository.
...
# Create eslint-config-next Instruction File

Create or update .github/instructions/eslint-config-next.instructions.md as a complete markdown instruction file with YAML front matter.

Requirements:
- Set name to the technology name.
- Set description to practical guidance for using eslint-config-next in this codebase.
- Set applyTo to: eslint.config.mjs.
...
Output:
- Return only the final markdown content for .github/instructions/eslint-config-next.instructions.md.
